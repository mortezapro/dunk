            ...
            <div class="panel panel-default card-view">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="{{route("insertRewardRoute")}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="form-group col-lg-4">
                                    ...
                                    <select class="form-control" name="cat_id" id="cat_id">
                                        @foreach( $reward_cats as $reward_cat)
                                            <option value="{{$reward_cat->cat_id}}">{{$reward_cat->cat_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-lg-8">
                                    ...
                                    <input value="{{old("reward_title")}}" rows="4" cols="50" id="reward_title" name="reward_title" class="form-control" placeholder="">
                                </div>
                                
                                <div class="form-group col-lg-6">
                                    <label class="control-label mb-10 text-left" for="reward_coin">تعداد سکه<span class="help"></span></label>
                                    <input value="{{old("reward_coin")}}" type="text" id="reward_coin" name="reward_coin" class="form-control" placeholder="">
                                </div>
                                <div class="form-group col-lg-6">
                                 ...
                                 <div class="form-group col-lg-6">
                                    ...
                                    <input value="{{old("reward_link")}}" type="text" id="reward_link" name="reward_link" class="form-control" placeholder="">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label class="control-label mb-10 text-left" for="reward_desc">توضیحات<span class="help"></span></label>
                                    <textarea type="text" id="reward_desc" name="reward_desc" class="form-control" placeholder="">{{old("reward_desc")}}</textarea>
                                </div>
