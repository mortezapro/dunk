...
@section("content")
    ...
    <div class="row">
        <a href="{{route("insertRewardCategoryRoute")}}"><button id="add_car_btn" class="btn btn-primary">افزودن</button></a>
    </div>
    <div class="row">
        <div class="col-lg-6">
            <table id="tbl_car" class="table table-striped">
                ...
                @foreach($categories as $category)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route("editRewardCategoryRoute",['id'=>$category->cat_id])}}"><button class="btn btn-primary"><i class="fa fa-edit"></i> ویرایش</button></a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer2">
                                <a href="{{route("deleteRewardCategoryRoute",["id"=>$category->cat_id])}}"><button class="btn btn-danger"><i class="fa fa-edit"></i> بله</button></a>
