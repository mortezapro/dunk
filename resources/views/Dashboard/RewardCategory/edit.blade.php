            ...
            <div class="panel panel-default card-view">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="{{route("updateRewardCategoryRoute",['id'=>$category->cat_id])}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="form-group col-lg-12">
                                    <label class="control-label mb-10 text-left" for="category">نام دسته<span class="help"></span></label>
                                    <input value="{{$category->cat_name}}" type="text" id="category" name="category" class="form-control" placeholder="نام دسته">
                                </div>
                                <div class="form-group col-lg-12">
