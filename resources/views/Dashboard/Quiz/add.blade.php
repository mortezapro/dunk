            ...
            <div class="panel panel-default card-view">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="{{route("insertQuizRoute")}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="form-group col-lg-12">
                                    <label class="control-label mb-10 text-left" for="brand">نام آزمون<span class="help"></span></label>
                                    <input value="{{old("book_name")}}" type="text" id="quiz_name" name="quiz_name" class="form-control" placeholder="نام آزمون">
                                </div>
                                <div class="form-group col-lg-12">
                                    <label class="control-label mb-10 text-left" for="brand">زمان آزمون<span class="help"></span></label>
                                    <input value="{{old("quiz_time")}}" type="text" id="quiz_time" name="quiz_time" class="form-control" placeholder="امتیاز آزمون">
                                </div>
                                 <div class="form-group col-lg-12">
                                    <label class="control-label mb-10 text-left" for="brand">امتیاز آزمون<span class="help"></span></label>
                                    <input value="{{old("quiz_score")}}" type="text" id="quiz_score" name="quiz_score" class="form-control" placeholder="امتیاز آزمون">
                                </div>
                                <div class="form-group col-lg-12">
                                    <label class="control-label mb-10 text-left" for="brand">تعداد سوالات<span class="help"></span></label>
                                    <input value="{{old("quiz_count")}}" type="text" id="quiz_count" name="quiz_count" class="form-control" placeholder="تعداد سوالات">
                                </div>
                                <div class="form-group col-lg-12">
