                        ...
                        <div class="form-wrap">
                            <form action="{{route("insertQuizRoute")}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <input value="" type="text" id="quiz_name" name="quiz_name" class="form-control" placeholder="نام آزمون">
                                </div>
                                <div class="form-group col-lg-12">
                                    <label class="control-label mb-10 text-left" for="brand">زمان آزمون<span class="help"></span></label>
                                    <input value="" type="text" id="quiz_time" name="quiz_time" class="form-control" placeholder="امتیاز آزمون">
                                </div>
                                <div class="form-group col-lg-12">
