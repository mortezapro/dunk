...
@section("content")
    ...
    <div class="row">
        <a href="{{route("addSliderRoute")}}"><button id="add_slider_btn" class="btn btn-primary">افزودن</button></a>
    </div>
    <div class="row">
        @php $i=0; @endphp
        ...
        <div class="col-lg-4">
            <div class="panel panel-default card-view">
                ...
                <div  class="panel-wrapper collapse in">
                    <div  class="panel-heading">
                        <img class="img-responsive2" src="{{asset("dashboard/uploaded/images/sliders/$item->slider_img")}}" alt="">
                    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer2">
                            <a href="{{route("deleteSliderRoute",["id"=>$item->slider_id])}}"><button class="btn btn-danger"><i class="fa fa-edit"></i> بله</button></a>
