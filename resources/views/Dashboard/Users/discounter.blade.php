                    ...
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="{{route("usersUpdateRoute",["id"=>$user->user_id])}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-lg-6">
                                    <label class="control-label mb-10 text-left" for="user_password">کلمه ی عبور<span class="help"></span></label>
                                    <input value="" rows="4" cols="50" id="user_password" name="user_password" class="form-control" placeholder="">
                                </div>
                                <div class="form-group col-lg-6">
