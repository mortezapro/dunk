        ...
        <table id="tbl_question" class="table table-striped">
            ...
            @foreach($rewards as $reward)
                ...
                <tr>
                    ...
                    <td>{{$reward->reward_coin}}</td>
                    <td>{{\Morilog\Jalali\Jalalian::forge($reward->request_date)->format('%d %B %Y ساعت H:i')}}</td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer2">
                            <a href="{{route("deleteRewardRoute",["id"=>$reward->reward_id])}}"><button class="btn btn-danger"><i class="fa fa-edit"></i> بله</button></a>
