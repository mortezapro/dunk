                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-6">
                                    <button  onclick="window.location.href='{{route('addPost')}}';" style="float: left;" type="button" class="btn btn-primary btn-uppercase" ><i class="ti-plus mr-2"></i> افزودن </button>
                                </div>
