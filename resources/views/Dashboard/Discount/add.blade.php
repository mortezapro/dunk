            ...
            <div class="panel panel-default card-view">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="{{route("insertDiscountRoute")}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                       
                                <div class="form-group col-lg-6">
                                    <label class="control-label mb-10 text-left" for="book_name">کد تخفیف <span class="help"></span></label>
                                    <input value="{{old("discount_code")}}" type="text" id="discount_code" name="discount_code" class="form-control" placeholder="">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label class="control-label mb-10 text-left" for="nevisande">درصد<span class="help"></span></label>
                                    <input value="{{old("percent")}}" type="number" id="percent" name="percent" class="form-control" placeholder="">
                                </div>
                                
                                 <div class="form-group col-lg-6">
                                    <label class="control-label mb-10 text-left" for="anbar">انتخاب کاربر <span class="help"></span></label>
                                ...
                                <div class="form-group col-lg-6">
                                    <label class="control-label mb-10 text-left" for="anbar">وضعیت <span class="help"></span></label>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input class="form-control fromDate" type="text" name="from_date"/>
                                </div>
                                      <div class="form-group col-lg-6">
                                    <label class="control-label mb-10 text-left" for="tarikh_enteshar">تا تاریخ<span class="help"></span></label>
                                    <input class="form-control fromDate" type="text" name="to_date"/>
                                </div>
