...
@section("breadcrumb")
    <div class="row heading-bg">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">دسته بندی </h5>
        </div>
        <!-- Breadcrumb -->
            ...
            <div class="panel panel-default card-view">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form action="{{route("updatepostCategoryRoute",['id'=>$category->category_id])}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="form-group col-lg-12">
                                    <label class="control-label mb-10 text-left" for="category">نام دسته<span class="help"></span></label>
                                    <input value="{{$category->category_name}}" type="text" id="category" name="category" class="form-control" placeholder="نام دسته">
                                </div>
                                <div class="form-group col-lg-12">
                                    <label class="control-label mb-10 text-left" for="slug">آدرس دسته<span class="help"></span></label>
                                    <input value="{{$category->category_slug}}" type="text" id="slug" name="slug" class="form-control" placeholder="آدرس دسته">
                                </div>
                                <div class="form-group col-lg-12">
